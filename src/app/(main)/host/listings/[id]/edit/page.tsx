  ...
  return (
    <div className="mx-auto max-w-3xl space-y-10 px-4 py-10">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-medium">Cierres (mantenimiento / uso propio)</h2>
        <p className="text-sm text-muted-foreground">
          Intervalo en fechas tipo hotel: desde la primera noche bloqueada hasta el
          día de salida (exclusivo).
        </p>
